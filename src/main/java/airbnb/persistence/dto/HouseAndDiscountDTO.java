...
public class HouseAndDiscountDTO implements Serializable {
    ...
    public String toString() {
        return String.format("%-20s%-10d%-15d%-15d", houseDTO.getHouseName(), discountPolicyDTO.getDiscountDay(), discountPolicyDTO.getDiscount_amount(), discountPolicyDTO.getDiscount_amount());
    }
}
